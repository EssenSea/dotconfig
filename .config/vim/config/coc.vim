...
" NOTE: There's always complete item selected by default, you may want
" to enable no select by `"suggest.noselect": true` in your
" configuration file.
...
" Apply the most preferred quickfix action to fix diagnostic on the
" current line.
